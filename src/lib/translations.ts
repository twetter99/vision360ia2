...
const baseTranslations = {
  ...
  contactSection: {
    ...
    form: {
      ...
      slideoverTitle: 'Descarga la documentación técnica',
      slideoverSubtitle: 'Completa el formulario y recibe el dossier completo con especificaciones.',
    },
    toast: {
      ...
      downloadSuccess: {
        ...
        description: 'Tu PDF se está descargando. Un ingeniero te contactará en menos de 24h.',
      },
    },
  },
  languageBanner: {
  ...
  ca: {
    ...
    contactSection: {
        ...
        form: {
            ...
            slideoverTitle: 'Descarrega la documentació tècnica',
            slideoverSubtitle: 'Completa el formulari i rep el dossier complet amb especificacions.',
        },
        toast: {
            title: 'Missatge Enviat!',
            description: 'Gràcies per contactar-nos. Et respondrem aviat.',
            downloadSuccess: {
              title: 'Documentació enviada!',
              description: 'El teu PDF s’està descarregant. Un enginyer et contactarà en menys de 24h.',
            },
        },
    },
    languageBanner: {
  ...
  eu: {
    ...
    contactSection: {
        ...
        form: {
            ...
            slideoverTitle: 'Deskargatu dokumentazio teknikoa',
            slideoverSubtitle: 'Bete formularioa eta jaso dossier osoa zehaztapenekin.',
        },
        toast: {
            title: 'Mezua Bidalita!',
            description: 'Eskerrik asko gurekin harremanetan jartzeagatik. Laster erantzungo dizugu.',
            downloadSuccess: {
              title: 'Dokumentazioa bidalita!',
              description: 'Zure PDF deskargatzen ari da. Ingeniari batek 24h baino gutxiagoan kontaktatuko zaitu.',
            },
        },
    },
    languageBanner: {
