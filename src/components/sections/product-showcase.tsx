...
export function ProductShowcase({ translations: initialTranslations }: { translations: Translation['es'] }) {
  ...
  const videoCards = [
    {
      id: 'prod1',
      title: products?.prod1?.name || 'Sistema de Visión 360°',
      description: (products?.prod1?.description?.slice(0, 150) || 'Sistema de cámaras con visión completa del vehículo') + '...',
      vimeoId: products?.prod1?.vimeoId || '1133755711',
      thumbnail: products?.prod1?.videoPoster || '/images/winfin_Vision360ia_1.jpg',
      tag: 'Sistema 360',
    },
    {
      id: 'prod2',
      title: products?.prod2?.name || 'Sistema de Alertas ADAS',
      description: (products?.prod2?.description?.slice(0, 150) || 'Alertas inteligentes de seguridad para prevención de accidentes') + '...',
      vimeoId: products?.prod2?.vimeoId || '1133755727',
      thumbnail: products?.prod2?.videoPoster || '/images/winfin_Vision360ia_2.jpg',
      tag: 'Alertas ADAS',
    },
    {
      id: 'prod3',
      title: products?.prod3?.name || 'Análisis con IA',
      description: (products?.prod3?.description?.slice(0, 150) || 'Análisis predictivo y detección inteligente de riesgos') + '...',
      vimeoId: products?.prod3?.vimeoId || '1133755748',
      thumbnail: products?.prod3?.videoPoster || '/images/winfin_Vision360ia_3.jpg',
      tag: 'Análisis IA',
    },
  ];
